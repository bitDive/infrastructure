...
GIT_METHODS_ANALYSIS_DELAY_MS=60000
GIT_METHODS_ANALYSIS_LLM_PATCH=/generate
GIT_METHODS_ANALYSIS_LLM_TEMPERATURE=0.0
GIT_METHODS_ANALYSIS_LLM_MAX_TOKENS=900
LLM_URL=http://bitdive-llm-api:8001
```
