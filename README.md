...
# Your configuration smtp server
APP_EMAIL_SMTP_HOST=smtp.zoho.eu
APP_EMAIL_SMTP_PORT=587
APP_EMAIL_SMTP_ALERT_USER=alerts@bitdive.io
#APP_EMAIL_SMTP_ALERT_PASSWORD=
APP_EMAIL_SMTP_ALERT_EMAIL=alerts@bitdive.io
TOTAL_PROCESS_MEMORY=4g

APP_EMAIL_SMTP_INFORMATION_USER=bitdive@bitdive.io
APP_EMAIL_SMTP_INFORMATION_PASSWORD=
APP_EMAIL_SMTP_INFORMATION_EMAIL=bitdive@bitdive.io

# Your configuration proxy for smtp server
#APP_EMAIL_PROXY_HOST=
#APP_EMAIL_PROXY_PORT=
#APP_EMAIL_PROXY_USER=
#APP_EMAIL_PROXY_PASSWORD=
```
